...
// SetPrivate provides a mock function with given fields: private
func (_m *RosenTss) SetPrivate(private models.Private) error {
	ret := _m.Called(private)

	var r0 error
	if rf, ok := ret.Get(0).(func(models.Private) error); ok {
		r0 = rf(private)
	} else {
		r0 = ret.Error(0)
	}
...
// StartNewKeygen provides a mock function with given fields: _a0
func (_m *RosenTss) StartNewKeygen(_a0 models.KeygenMessage) error {
	ret := _m.Called(_a0)
...
type mockConstructorTestingTNewRosenTss interface {
	mock.TestingT
	Cleanup(func())
}

// NewRosenTss creates a new instance of RosenTss. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewRosenTss(t mockConstructorTestingTNewRosenTss) *RosenTss {
	mock := &RosenTss{}
	mock.Mock.Test(t)
